...
<body>
    ...
    <form action="kpploginprocess.php" method="post">
        <div class="container">
                    ...
                    <div class="card border border-light-subtle rounded-3 shadow-sm">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <div class="text-center mb-3">
                                <a href="#!">
                                    <img src="../images/folder.png" alt="logo" width="145" height="145" />
                                </a>
                            </div>
                            <div class="col-12 position-relative">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="kppemail" id="email"
                                        placeholder="Kpp Number (6 Digit)" required autocomplete="off"
                                        pattern="[0-9]{6}" value="<?php if (isset($_COOKIE["kppemail"])) {
                                            echo $_COOKIE["kppemail"];
                                        } ?>" maxlength="6" />
                                </div>
                            </div>
                            <div class="col-12 position-relative">
                                <div class="form-floating mb-3">
                                    <input type="password" class="form-control" name="kpppassword"
                                        pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{8,}$" id="password" value="<?php if (isset($_COOKIE["kpppassword"])) {
                                            echo $_COOKIE["kpppassword"];
