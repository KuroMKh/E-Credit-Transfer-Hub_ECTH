...
<head>
    ...
    <script src="../JS/adminpassword.js"></script>
</head>
                    ...
                    <div class="card border border-light-subtle rounded-3 shadow-sm">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <div class="text-center mb-3">
                                <a href="#!">
                                    <img src="../images/admin.png" alt="logo" width="145" height="145" />
                                </a>
                            </div>
                            <div class="col-12 position-relative">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="adminemail" id="email"
                                        placeholder="Admin Number (6 Digit)" required autocomplete="off"
                                        pattern="[0-9]{6}" value="<?php if (isset($_COOKIE["adminemail"])) {
                            ...
                            <div class="col-12 position-relative">
                                <div class="form-floating mb-3">
                                    <input type="password" class="form-control" name="adminpassword"
                                        pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{8,}$" id="password" value="<?php if (isset($_COOKIE["adminpassword"])) {
